...
from cloudshell.extremenetworks.command_actions.add_remove_vlan_actions import (
    AddRemoveVlanActions,
)

# from cloudshell.extremenetworks.command_actions.iface_actions import IFaceActions


class ExtremenetworksConnectivityFlow(AbstractConnectivityFlow):
    ...
    def __init__(
        ...
        super(ExtremenetworksConnectivityFlow, self).__init__(logger)
    ...
    def _add_vlan_flow(self, vlan_range, port_mode, full_name, qnq, c_tag, vm_uid=None):
        self._logger.debug("xxx add vlan flow")
        pass

    def _remove_vlan_flow(self, vlan_range, full_name, port_mode, vm_uid=None):
        self._logger.debug("xxx remove vlan flow")
        pass
